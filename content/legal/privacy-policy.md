...
description: 'We value the importance of online privacy of our users. We do not sell or rent any information you provide to us with any third party company.'
image: 'privacy.jpg'
---

This Privacy Policy (“Policy”) explains how information about you or associated with you (“personal information”) is collected, used and disclosed by DailyChatLine and its affiliates, (“DailyChatLine,” “we” or “us”). This Policy covers our treatment of personal information when you use or sign up as a member of the DailyChatLine® Chatline service (the “Chatline”), or use and interact with DailyChatLine® website (“Website”) and applies only to the practices of the companies we own, control, or are united with under common control (collectively, the “Services”).
...
- Other companies owned by or under common ownership as DailyChatLine, which also includes our subsidiaries (i.e., any organization we own or control) or our ultimate holding company (i.e., any organization that owns or controls us) and any subsidiaries it owns. These companies will use your personal information in the same way as we can under this Policy;
- Third party vendors, consultants and other service providers that perform services on our behalf, in order to carry out their work for us, which may include identifying and serving advertisements, content or service fulfillment, or providing analytics services;
...
- Third parties at your request. For example, on our voice services, you may elect to be transferred to a third party after hearing a third party advertisement and providing a keypress to continue to the third party’s messaging. In that instance, we will transfer your phone number and the live call from our service to the third party service and this privacy policy will no longer apply.
